...
echo $ADDR
./build/bin/geth --datadir $DIRECTORY --unlock $ADDR --password ./pass --debug --verbosity 4 --networkid 930412 --ipcdisable --port 619$no --rpc --rpccorsdomain "*" --rpcport 81$no --bootnodes $bootnode_addr console 
